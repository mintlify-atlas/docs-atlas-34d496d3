...
<ParamField path="options" type="object">
  ...
  <Expandable title="options">
    ...
    <ParamField path="eol" type="string" default="\n">
      Line terminator character(s). Use `\r\n` for Windows-style endings, or `auto` to detect from input.
    </ParamField>
    ...
    <ParamField path="indent_inner_html" type="boolean" default="false">
      Indent the contents of `<head>` and `<body>` elements. When `false`, their direct children are placed at the root indentation level.
    </ParamField>
    ...
    <ParamField path="wrap_line_length" type="number" default="250">
      Wrap lines that exceed this many characters. Set to `0` to disable.
    </ParamField>
